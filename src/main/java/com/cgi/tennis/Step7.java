...
//Apply rule 5 (One dot per line). Already mostly compliant, but ensure no chaining.
public class Step7 implements TennisGame {
    ...
    public Step7(String player1Name, String player2Name) {
    ...
    private String getLateGameScore() {
        ...
        String leadingName = leadingPlayer.getValue();
